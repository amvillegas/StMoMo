...
#' stochastic mortality models.  This family of models emcopasess
#' many models proposed in the literature includeing the well-known
...
#' + \beta_x^{(0)}\gamma_{t-x}} \deqn{v: \{\alpha_{xt}, \beta_x^{(1)},..., 
